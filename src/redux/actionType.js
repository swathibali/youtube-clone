...
export const SUBSCRIPTION_REMOVE_REQUEST = 'SUBSCRIPTION_REMOVE_REQUEST'
export const SUBSCRIPTION_REMOVE_SUCCESS = 'SUBSCRIPTION_REMOVE_SUCCESS'
export const SUBSCRIPTION_REMOVE_FAIL = 'SUBSCRIPTION_REMOVE_FAIL'
...
export const LIKE_REQUEST = 'LIKED__REQUEST'
export const LIKE_SUCCESS = 'LIKED__SUCCESS'
export const LIKE_FAIL = 'LIKED__FAIL'

export const DISLIKE_REQUEST = 'DISLIKED__REQUEST'
export const DISLIKE_SUCCESS = 'DISLIKED__SUCCESS'
export const DISLIKE_FAIL = 'DISLIKED__FAIL'
